        ...
        <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-1/2">
                <Card className="overflow-hidden sticky top-24">
                    <div className="aspect-[4/3] md:aspect-auto md:h-[calc(100vh-150px)] relative bg-gray-100 cursor-pointer group" onClick={() => window.open(bill.imagePath, '_blank')}>
                        <img src={bill.imagePath} alt={bill.storeName} className="w-full h-full object-contain bg-gray-900/5" />
